...
export const Provider = () => {
  ...
  const newSteps = [
    ...
    },
    {
      id: "step-1",
      title: "CodeEditor",
      text: "CodeEditor is the core feature of A platform. Here you can practice coding problems, optimize your code, and debug your code. If got stuck, you can always ask for help to get hints.",
      attachTo: {
        element: "#info-0",
        on: "top",
      },
