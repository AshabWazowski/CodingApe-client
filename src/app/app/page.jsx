...
const Application = () => {
  ...
  const cardData = [
    ...
    {
      title: "Get assisted",
      description: "Learn to code and clarify your doubts with AI Assistant.",
      image: "/assets/ai-buddy.png",
      info: "AI Assistant",
    ...
    },
    {
      ...
      image: "/assets/study-planner.png",
      info: "Study Planner",
    ...
    },
    {
      ...
      image: "/assets/roadmap-planner.png",
    ...
    },
    {
      ...
      image: "/assets/interview-prep.png",
      info: "Interview Prep",
      buttonText: "Prepare",
      path: "/app/interview",
    },
