    ...
    <div className="flex flex-col w-full h-[calc(100vh-64px)]">
        ...
        <div className="flex items-center justify-center w-full rounded-3xl bg-opacity-10 h-[calc(100vh-108px)] shadow-border py-8 px-4 bg-background duration-300 mt-2 shadow-lg transition-all border border-border">
          <div className="flex flex-col w-3/5 h-full p-8 items-start justify-center py-12">
            <h1 className="text-4xl font-extrabold underline mb-2">
              <span className="text-indigo-600">Coding</span>Ape
            </h1>
            ...
            <span className="text-sm mt-4 text-muted-foreground">
              <span className="font-bold">Note:</span> CodingApe is still in
      ...
      <div className="w-full h-16 bg-background bg-opacity-10 flex items-center justify-center border-t-[1px] border-border py-2">
        <span className="text-muted-foreground">
          &copy; {new Date().getFullYear()} CodingApe. All rights reserved.
        </span>
      </div>
    </div>
  );
